...
trainDataset = YOLOv3_VOCDataset.VOCDataset("C:/Users/Admin/Desktop/VOC2007数据集/VOCtrainval_06-Nov-2007/", 416, True)
trainLoader = torch.utils.data.DataLoader(dataset = trainDataset, batch_size = batchSize, shuffle = True)
validateDataset = YOLOv3_VOCDataset.VOCDataset("C:/Users/Admin/Desktop/VOC2007数据集/VOCtest_part/", 416, False)
...
for epoch in rangeObj:
    ...
    for i, data in enumerate(trainLoader, 1):
        ...
        output = model(img)
        loss = criterion(output, label, YOLOv3_VOCDataset.VOCDataset.anchorBox)
